...
<div className='flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8'>
  <div className='flex items-center gap-x-4 mb-8'>
    <div className='w-20 h-20 p-1 border border-gray-300 rouded-full'>
      <img src={house.agent.image} alt=''/></div>
    <div>
...
<input className='border border-gray-300 focus-border-violet-700 outline-none rounded w-full px-4 h-14 text-sm' type='text' placeholder='Phon Number'/>
<textarea className='border border-gray-300 focus:border-violet-700 outline-none resize-none rounded w-full p-4 h-36 text-sm text-gray-400' placeholder='Message' defaultValue="Hello, I'm Interested in [Modern Apartment]"></textarea>
