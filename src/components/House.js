...
return (
<div className=' bg-white shadow-1 p-5 rounded-1g
rounded-t1-[90px] w-full max-w-[352px] mx-auto
cursor-pointer hover:shadow-2x1 transition'>
<img className= 'mb-8' src={image} alt='' />
<div className= 'mb-4 flex gap-x-2 text-sm'>
<div className='bg-green-500 rounded-full
Itext-white px-3'>{type} </div>
<div className='bg-violet-500 rounded-full
text-white px-3'>
{country}
</div>
</div>
<div className='text-lg font-semibold max-w
[260px]'> {address} </div>
